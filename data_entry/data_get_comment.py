...
class DataGetComment:
    ...
    def write_sqlite_db(self, movie_df):
        ...
        try:
            movie_df.to_sql('movie_data_comment', con=engine, if_exists='replace', index=False)
            print('写入成功！')
        except Exception as e:
            print(e)

    def calculate(self):
        movie_df = self.get_top100_comment()
        self.write_sqlite_db(movie_df)
